...
let message = document.querySelector('#bericht');
if (!name.value || !email.value || !message.value) {
	alertify.error('kijk na of u alles heeft ingevuld.');
} else {
	$.ajax({
		url: "https://formspree.io/judithvandevelde2000@gmail.com"
		method: "POST"
		data: $(this).serialize(),
		dataType: "json"
	})
...
e.preventDefault()
$(this).get(0).reset()
alertify.success('bericht verzonden')
}
})*/
